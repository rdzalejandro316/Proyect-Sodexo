...
namespace SiasoftAppExt
{
    ...
    public partial class InBuscarReferencia : Window
    {
        ...
        public DataTable GetDataTable(string _where)
        {
            try
            {
                string sql = "select top 300 "  + cmpnombre + " as nombre," + cmpcodigo + " as codigo,val_ref,00000000.00 as saldo,cod_prv,inmae_ref.cod_tip,tip.por_des,tip.por_desc  from inmae_ref inner join inmae_tip as tip on tip.cod_tip=inmae_ref.cod_tip "+ _where + " order by nom_ref" ;
        ...
        private string TxtConvertTextSinFiltro(string txt)
        {
            ...
            return "rtrim(cod_ref) like '" + s.Trim() + "%'";
        }
        ...
        private void SelectItem()
        {
            ...
            if (row != null)
            {
                ...
                SiaWin.Func.Var["_UltimaReferenciaBuscar"] = row["codigo"].ToString().Trim();
            }
            else
            {
                this.IdRowReturn = -1;
